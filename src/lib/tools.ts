...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    caseStudies: [
      ...
      {
        place: "りとけい(420島への限られた取材・支援リソース配分)",
        intro:
          "国内約420の有人離島(人口約100万人)を対象に情報発信を行う認定NPO法人が、限られた人員・予算の中で、取材・支援の優先順位をどう決めるかを検討する事例です。",
        steps: [
          {
            title: "現状データ・意見",
            description:
        ...
        embedLabel: "りとけい(420島への限られた取材・支援リソース配分)の事例をみる",
      },
    ],
  },
  {
