  ...
  },
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        intro:
          "職員定数27人に対し現員21人、退職により今後14人程度まで減少が見込まれる中で、限られた人員でも行政サービスを維持する方法を検討する事例です。",
        steps: [
          {
            title: "現状データ・意見",
            description:
              "職員数の推移、地方創生交付金の未消化率などの行政データと、住民・職員・移住検討者など立場ごとの意見を集約",
          },
          {
            title: "AI分析",
            description:
              "定型業務の負荷、企画・申請業務の停滞、属人化リスクの3つに課題を分解して整理",
          },
          {
            title: "施策候補",
            description:
              "定型業務のデジタル化、広域連携・応援職員制度の活用、移住・採用の連動など、短期・中期・長期の見込みつきで提示",
          },
          {
            title: "意思決定シミュレーション",
            description:
              "「対面での相談がしづらくなるのでは」といった少数意見への向き合い方を含めて合意形成を検討",
          },
        ],
