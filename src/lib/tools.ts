  ...
  },
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        intro:
          "国内約420の有人離島(人口約100万人)を対象に情報発信を行う認定NPO法人が、限られた人員・予算の中で、取材・支援の優先順位をどう決めるかを検討する事例です。合意形成プラットフォームに蓄積されたステークホルダー・意見・合意記録を反映し、財源設計やAIとの業務分担まで踏み込んだ最新版(v6)です。",
        steps: [
          {
            title: "ミッション・係数",
            description:
              "「島の宝を未来につなぐ」というミッションと、対象カバー率・財源安定度など8つの係数を1枚に整理",
          },
          {
            title: "課題と対策案",
            description:
              "財政基盤の弱さ、情報空白の固定化、移動コスト、担い手不足などを優先度つきで整理し、対策案と推奨比率を提示",
          },
          {
            title: "財源設計",
            description:
              "寄付・会費中心から、自治体委託・国費連動・企業版ふるさと納税を組み合わせた財源モデルへの移行案",
          },
          {
            title: "AI分担・実行計画",
            description:
              "AIが担う作業と人が最終責任を持つ作業を明確に分け、30・60・90日の実行計画に落とし込む",
          },
        ],
      ...
      },
      {
        ...
        intro:
          "国内約420の有人離島(人口約100万人)を対象に情報発信を行う認定NPO法人が、限られた人員・予算の中で、取材・支援の優先順位をどう決めるかを検討する事例の初期版です。以後、合意形成プラットフォームでの議論をもとに上記の最新版へと発展しています。",
        steps: [
          {
            title: "現状データ・意見",
            description:
              "対象範囲・活動エリアの広さ、経営を圧迫する交通費、コロナ禍で危機的状況になった経緯などの団体データと、スタッフ・会員・取材先の島など立場ごとの意見を集約",
          },
          {
            title: "AI分析",
            description:
              "取材依頼への対応力の限界、広域移動コストによる経営圧迫、収益基盤の不安定さの3つに課題を分解して整理",
          },
          {
            title: "施策候補",
            description:
              "AI活用による取材メモ整理の効率化、他団体・地域メディアとの連携、配分基準の明文化など、短期・中期・長期の見込みつきで提示",
          },
          {
            title: "意思決定シミュレーション",
            description:
              "「効率化で現地取材の温かさが失われるのでは」といった少数意見への向き合い方を含めて合意形成を検討",
          },
        ],
        embedUrl: "/case-studies/ritokei-resource-dss.html",
        embedLabel: "りとけい(初期版)の事例をみる",
      },
    ],
  },
  {
