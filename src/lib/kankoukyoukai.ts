...
export const kankoukyoukaiBranches: KankoukyoukaiBranch[] = [
  {
    ...
    description:
      "世界自然遺産・屋久島の観光事業者(宿泊・ガイド・飲食・物産など)が加盟する一般社団法人です。事務局は屋久島町安房。以前の任意団体「屋久島観光協会」を経て一般社団法人として再編されています(法人番号はgBizINFO上で別番号として確認)。シマの北極星分室が屋久島町ですでに進めている自治体向け・商工会向けの取り組みを土台に、観光事業者向け意思決定支援を検討しているパイロット候補です。",
    status: "準備中",
    stats: [
    ...
    issues: [
      {
        ...
        status: "提起",
        summary:
          "屋久島観光協会が自ら公開している「30年ビジョン策定文章」(2025年7月公開)に明記されている論点です。「外資や新規事業者の無秩序な参入に対して一定のルール付けや指導、勧告などを行える団体となる資質を高める」とあり、観光協会自身が課題として掲げています。Notion上には自治体・観光協会事務局・会員事業者4名分の立場表明とゴールを登録済みですが、シマの北極星として直接ヒアリングして最終確認した内容ではないため、Notion上のステータスは「提起」のままです。",
  ...
  },
  {
    ...
    description:
      "観光客増加に伴うオーバーツーリズム対策を検討している、テスト用の架空の観光協会です。この論点には、シマの北極星の3つのツールの一つ「しまのみんな会議」のカードゲームを設置しており、実際にカードを選んで意見を送信して体験できます。",
    status: "活動中",
    stats: [
    ...
    issues: [
      {
        ...
        cardGameUrl: "https://shimatetsudai-issue-cardgame.vercel.app/games/issue-minamo-kankoukyoukai-overtourism/cards",
        cardGameLabel: "しまのみんな会議で意見を出す",
      },
    ],
  },
