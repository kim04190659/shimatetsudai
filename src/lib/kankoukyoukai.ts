    ...
    issues: [
      {
        ...
        status: "提起",
        summary:
          "屋久島観光協会が自ら公開している「30年ビジョン策定文章」(2025年7月公開)に明記されている論点です。「外資や新規事業者の無秩序な参入に対して一定のルール付けや指導、勧告などを行える団体となる資質を高める」とあり、観光協会自身が課題として掲げています。推測ではなく一次資料(公式PDF)にもとづく論点ですが、しまてつだいとして直接ヒアリングして確認した内容ではないため、Notion上のステータスは「提起」のままです。",
      },
    ],
  },
];
