...
export const metadata: Metadata = {
  ...
  description:
    "NEC・鹿児島高専同窓会・サービス学会・高専教育DX・離島経済新聞社・シマの北極星。複数の立場で社会課題解決に取り組む木村好孝のプロフィールページ。",
};
...
const ROLES: Role[] = [
  ...
  },
  {
    label: "自主開発",
    value:
      "シマの北極星 支援者・開発者。難聴の方の会話支援「てつだって」、自治体の意思決定支援など、社会課題解決の仕組みをClaudeと共に開発。",
  },
];
