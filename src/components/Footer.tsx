    ...
    <footer className="border-t border-brand-soft bg-brand-soft/40">
      <div className="mx-auto max-w-5xl px-5 py-10 text-sm text-foreground/70">
        <div className="grid gap-8 sm:grid-cols-3">
          <div>
            <p className="text-base font-bold text-brand-dark">離島経済新聞社 しまてつだい分室</p>
            <p className="mt-2 leading-relaxed">
              離島経済新聞社の分室として、離島や地方の暮らしと社会に寄り添うツールを開発しています。
            </p>
          </div>
          <div>
        ...
        <p className="mt-8 text-xs text-foreground/50">
          © {new Date().getFullYear()} 離島経済新聞社 しまてつだい分室(仮). All rights reserved.
        </p>
      </div>
    </footer>
  );
